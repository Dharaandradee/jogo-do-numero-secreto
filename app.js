...
// 2 let linguagemDeProgramação = ['javaScript', 'C', 'C++', 'Kotlin' 'Python'];
// 3 linguagemDeProgramação.push('java', 'Ruby', 'Golang');

//  4 let nomes = [ "Dhara", "Guilherme" "Wallyson"];
//  5console.log(nomes[0]);

//  6 let name = ["Camilly", "Sogra", Mãe];
//     console.log(name[1]);
